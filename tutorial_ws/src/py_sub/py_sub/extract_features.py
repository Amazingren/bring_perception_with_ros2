...
model_path = "/home/bingo/Desktop/tutorial_ws/src/py_sub/cosface.h5"
sizes=112
test_gallery_path = "/home/bingo/Desktop/tutorial_ws/saved_images"
...
gallery_file_list = glob.glob(os.path.join(test_gallery_path, "*.png"))
